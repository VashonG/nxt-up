...
import { UsersController } from 'src/interface/user/user.controller';
import { CommandBusMock, QueryBusMock } from 'user-service/src/test/mocks';
...
import { UserDto } from 'user-service/src/legacy/dto';
...
import {
  ...
  USER_SORTS_DATA,
} from 'user-service/src/test/values/users.const.dto';
...
} from 'user-service/src/commands';
import { GetPairsQuery, GetSortedQuery } from 'user-service/src/queries';
