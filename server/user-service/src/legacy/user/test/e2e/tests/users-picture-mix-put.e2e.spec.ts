...
import { USERS_PICTURE_MIX_PUT_DTO } from 'user-service/src/test/values/users.e2e-const.dto';
import { USERS_PICTURE_MIX_PUT_EXPECT } from 'user-service/src/test/values/users.e2e-const.expect';

const currentUserId = 'picture_mix_current_user_id';
const secondUserId = 'picture_mix_second_user_id';

describe('user/picture/mix (PUT)', () => {
